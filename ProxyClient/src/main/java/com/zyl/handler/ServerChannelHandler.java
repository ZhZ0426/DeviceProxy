        ...
        realBootstrap.connect(realIp,22).addListener(new ChannelFutureListener() {
            ...
            public void operationComplete(ChannelFuture channelFuture) throws Exception {
                ...
                if(channelFuture.isSuccess()){
                    ...
                    channelHandlerContext.channel().attr(Constant.CHANNEL_ATTRIBUTE_KEY).set(channelFuture.channel());
                    channelFuture.channel().attr(Constant.CHANNEL_ATTRIBUTE_KEY).set(channelHandlerContext.channel());
